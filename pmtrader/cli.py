...
from cli_common import console, _api, _pnl_color, _deprecated
...
# `crypto` and `sports` live in their own modules — split out for size;
# registered here the same way every other top-level group attaches to `cli`.
from cli_crypto import crypto_group  # noqa: E402
from cli_sports import sports_group  # noqa: E402

cli.add_command(crypto_group)
cli.add_command(sports_group)
