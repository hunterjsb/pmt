...
// The tape plumbing lives in crate::jsonl (public half of the crate); this
// re-export keeps every strategy-side caller's `updown_model::` path intact.
pub(crate) use crate::jsonl::{append_jsonl, engine_dir};
