...
- **That acceptance test is now a committed fixture, not a paragraph** (issue #5,
  `pmengine/src/strategies/private/fixtures/btc-updown-15m-1787449500.json`, in the
  pmt-strategies submodule since the private split):
  `pmengine replay --fixtures src/strategies/private/fixtures`
  ...
  Catalog, invariant vocabulary and the known gaps:
  `pmengine/src/strategies/private/fixtures/README.md`.
...
- **R7 Correlation-aware fleet cap — BUILT DARK 2026-08-23, A/B says DO NOT ARM YET**
  ...
  - The counterfactual said +$194/night at $250 (41c per blocked dollar). Replaying the
    ...
    reach, not complements. See docs/LESSONS.md#L37.
